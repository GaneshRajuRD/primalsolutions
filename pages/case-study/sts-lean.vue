<template>
    <div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="content">
                            ...
                            <h1 class="my-4">
                                Driving Operational Excellence: Lean Transformation of a Leading Sheet Metal Manufacturer in Hosur
                            </h1>
                            <p class="mb-5 mb-lg-0">8 min read</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
        ...
        <div class="container py-5 caseStudyContent mb-5">
            <h4>The Company</h4>
            <p>
                A leading sheet metal manufacturing company based in Hosur, specializing in a diverse range of sheet metal and press components for commercial vehicles, defense vehicles, off-road vehicles, and the electrical and electronics sectors, set out to enhance its production efficiency and streamline operations. As demand increased, the company recognized the need to optimize its manufacturing processes to boost productivity, improve quality, and reduce operational costs.
            </p>
            <h4>The Challenge</h4>
            <p>
            ...
            <ul>
                <li>Achieved a 30% improvement in productivity through optimized workflows.</li>
                <li>Improved space utilization by 20%.</li>
                <li>Enhanced problem-solving capabilities through Quality Control Circle (QCC) team approach.</li>
                <li>Reduced Cost of Poor Quality (COPQ) by strengthening quality systems and process controls.</li>
                <li>Shortened lead times and improved overall operational responsiveness.</li>
            </ul>
