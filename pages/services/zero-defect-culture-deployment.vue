                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">Quality Management System Strengthening</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Established Quality Systems and Practices through "3D Concept"</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Continuous Improvement & Problem-Solving Culture</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                            ...
                            <ul class="strengthList">
                                ...
                                <li>
                                    <strong>Continuous Improvement & Problem-Solving Culture</strong>
                                     Foster a culture of ongoing improvement and proactive problem-solving.
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row mt-4">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="strategyCard">
                            <h5 class="fw-light">
                                To improve Customer audit score >85%
                            </h5>
                        </div>
                    </div>
                </div>
