<template>
    <div>
        ...
        <div class="serviceBnr">
            <div class="container">
                <div class="content text-center">
                    <h1 class="fw-bold">Business Transformation</h1>
                    <p class="width-75">
                        We redesign outdated processes and build high-performing systems that help teams move faster and operate with confidence.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">End-to-end process redesign</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Lean integration & culture shift</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Scalability-focused systems</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                    ...
                    <h1 class="playfairText themeText mt-3">Strengthen your operations</h1>
                    <p>
                    ...
                    <ul class="strengthList">
                        <li>Redesign processes for improved performance</li>
                        <li>Drive lean adoption across all departments</li>
                        <li>Build scalable systems for long-term growth</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div ref="textSlider" class="textSlider">
            <div class="text-item">Transforming Operations for Peak Performance</div>
            <div class="text-item">Transforming Operations for Peak Performance</div>
            <div class="text-item">Transforming Operations for Peak Performance</div>
            <div class="text-item">Transforming Operations for Peak Performance</div>
            <div class="text-item">Transforming Operations for Peak Performance</div>
            ...
            <div class="row mt-4">
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="strategyCard">
                        ...
                        <h5 class="fw-light">
                            26% faster cycle-time performance
                        </h5>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="strategyCard">
                        <img src="/assets/image/tickImg5.png" class="img-fluid" alt="">
                        <h5 class="fw-light">
                            37% improvement in workflow stability
                        </h5>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="strategyCard">
                        <img src="/assets/image/tickImg5.png" class="img-fluid" alt="">
                        <h5 class="fw-light">
                            19% reduction in operational losses
                        </h5>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="strategyCard">
                        <img src="/assets/image/tickImg5.png" class="img-fluid" alt="">
                        <h5 class="fw-light">
                            Higher adoption of lean practices
                        </h5>
                    </div>
                </div>
            </div>
