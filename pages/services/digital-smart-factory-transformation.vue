<template>
    <div>
                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">Integrated Digitalization and Visual Control Systems (VCS)</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Digital Quality Management System (DQMS)</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Advanced Analytics & Predictive Maintenance</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-lg-5">
                            <div class="processImg">
                                <img src="/assets/image/DigitalSmartFactoryTransformationImg.webp" class="mt-sm-5 mt-lg-0  img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                            ...
                            <ul class="strengthList">
                                <li>
                                    <strong>Integrated Digitalization and Visual Control Systems (VCS)</strong>
                                </li>
                                    Implement smart digital systems for real-time monitoring and control.
                                <li>
                                    <strong>Digital Quality Management System (DQMS)</strong>
                                </li>
                                    Digitize quality processes to ensure compliance and traceability.
                                <li>
                                    <strong>Advanced Analytics & Predictive Maintenance</strong>
                                </li>
                                    Use data analytics to predict failures and optimize maintenance.
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div ref="textSlider" class="textSlider">
            <div class="text-item">Integrated Digitalization &amp; Visual Control Systems (VCS)</div>
            <div class="text-item">Digital Quality Management System (DQMS)</div>
            <div class="text-item">Advanced Analytics &amp; Predictive Maintenance</div>
            <div class="text-item">Integrated Digitalization &amp; Visual Control Systems (VCS)</div>
            <div class="text-item">Digital Quality Management System (DQMS)</div>
            <div class="text-item">Advanced Analytics &amp; Predictive Maintenance</div>
            <div class="text-item">Integrated Digitalization &amp; Visual Control Systems (VCS)</div>
        ...
        <div class="container pt-5">
            ...
            <h1 class="playfairText themeText mt-3">Turning Strategy<br> Into Real Progress</h1>
        </div>
...
.serviceBnr {
    position: relative;
    background-image: linear-gradient(68deg,rgb(0, 0, 0, 0.5),rgb(0, 0, 0,0)),url('/assets/image/Smart-factory-tarnsformation.webp');
