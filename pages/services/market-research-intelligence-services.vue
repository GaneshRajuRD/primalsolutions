                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">Industry & Market Assessment</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Customer & Demand Analysis</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Competitive Benchmarking</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container my-5">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                            ...
                            <h1 class="playfairText themeText mt-3">Analyze Market Landscape</h1>
                            <p>
                                Market Landscape Analysis: Analyze industry trends, market size, growth drivers, and potential risks. Customer & Demand Research: Identify customer needs, buying behavior, preferences, and demand patterns. Competitive Benchmarking: Evaluate competitors' capabilities, pricing strategies, and market positioning. Market Entry & Feasibility Studies: Assess the attractiveness and viability of new markets, geographies, and product opportunities.
                            </p>
                            <ul class="strengthList">
                                <li>
                                    <strong>Market Landscape Analysis</strong>
                                </li>
                                    Analyze industry trends, market size, growth drivers, and risks.
                                <li>
                                    <strong>Customer & Demand Research</strong>
                                </li>
                                    Identify customer needs, buying behavior, preferences, and demand patterns.
                                <li>
                                    <strong>Competitive Benchmarking</strong>
                                </li>
                                    Evaluate competitors' capabilities, pricing strategies, and market positioning.
                                <li>
                                    <strong>Market Entry & Feasibility Studies</strong>
                                </li>
                                    Assess new markets, geographies, and product opportunities.
                            </ul>
                        </div>
                    </div>
                </div>
...
.serviceBnr {
    position: relative;
    background-image: linear-gradient(68deg,rgb(0, 0, 0, 0.5),rgb(0, 0, 0,0)),url('/assets/image/Market-Research-service.webp');
