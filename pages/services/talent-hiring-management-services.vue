                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">Strategic Talent Acquisition</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Leadership & High-Potential Talent Development</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Employee Engagement & Retention Programs</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container my-5">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                            ...
                            <h1 class="playfairText themeText mt-3">Manage Talent Hiring and Development</h1>
                            <p>
                                Talent Acquisition Strategy & Planning: Define hiring strategies aligned with business goals. Competency Mapping & Role Profiling: Identify skills and competencies required for roles. Leadership & High-Potential Talent Development: Develop programs for future leaders. Performance Management System Design: Implement frameworks to measure and improve performance. Employee Engagement & Retention Programs: Boost workforce motivation and reduce attrition.
                            </p>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="strategyCard strategyCard2">
                            <h5 class="fw-light">
                                Deploy scalable HR performance management systems
                            </h5>
                        </div>
                    </div>
                </div>
