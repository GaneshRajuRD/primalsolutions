<template>
    <div>
                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">AIAG - Core Tools, Lean Tools, Problem solving through disciplinary approach</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">ESG Implementation</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">ISO, IATF and Integrated certification for manufacturing</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-lg-5">
                            <div class="processImg">
                                <img src="/assets/image/SkilldevelopmentprogramsImg.webp" class="mt-sm-5 mt-lg-0  img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                            <span class="tag">What we do</span>
                            <h1 class="playfairText themeText mt-3">Develop Skills and Certifications</h1>
                            <p>
                                AIAG – Core Tools, Lean Tools, Problem Solving: Train teams in core manufacturing and problem-solving skills. ESG Implementation: Guide organizations to implement sustainable and responsible practices. ISO, IATF, and Integrated Certification: Support certification readiness and compliance for manufacturing standards.
                            </p>
                            <ul class="strengthList">
                                <li>
                                    <strong>AIAG – Core Tools, Lean Tools, Problem Solving</strong>
                                </li>
                                    Train teams in core manufacturing and problem-solving skills.
                                <li>
                                    <strong>ESG Implementation</strong>
                                </li>
                                    Guide organizations to implement sustainable and responsible practices.
                                <li>
                                    <strong>ISO, IATF, and Integrated Certification</strong>
                                </li>
                                    Support certification readiness and compliance for manufacturing standards.
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div ref="textSlider" class="textSlider">
            <div class="text-item">AIAG - Core Tools, Lean Tools, Problem solving</div>
            <div class="text-item">ESG Implementation</div>
            <div class="text-item">ISO, IATF and Integrated certification for manufacturing</div>
            <div class="text-item">AIAG - Core Tools, Lean Tools, Problem solving</div>
            <div class="text-item">ESG Implementation</div>
            <div class="text-item">ISO, IATF and Integrated certification for manufacturing</div>
            <div class="text-item">AIAG - Core Tools, Lean Tools, Problem solving</div>
                ...
                <div class="row mt-4">
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="strategyCard">
                            <h5 class="fw-light">
                                Build structured problem-solving skills
                            </h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="strategyCard">
                            <h5 class="fw-light">
                                Implement ESG and sustainability practices
                            </h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="strategyCard">
                            <h5 class="fw-light">
                                Support ISO, IATF, and integrated certifications
                            </h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="strategyCard strategyCard2">
                            <h5 class="fw-light">
                                Enhance skills and operational excellence
                            </h5>
                        </div>
                    </div>
                </div>
