                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">Strategic Business Planning</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Market Entry and Scalable Growth Strategy</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                            ...
                            <ul class="strengthList">
                                ...
                                <li>Align leadership and cross-functional teams around shared goals</li>
                                <li>Replace assumptions with data-driven, measurable direction</li>
                            </ul>
                        </div>
                    </div>
                </div>
