        ...
        <div class="serviceBnr">
            <div class="container">
                <div class="content text-center">
                    ...
                    <p class="width-75">
                        We help you create clear, actionable strategies that align your long-term goals with real-world operational realities.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="deliverables">
                    ...
                    <div class="delivery2">
                        <div class="content">
                            ...
                            <p class="mb-0">Strategic planning & KPI alignment</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Long-term growth roadmaps</p>
                        </div>
                    </div>
                    <div class="delivery2">
                        <div class="content">
                            <img src="/assets/image/tickImg3.png" class="tickImg img-fluid" alt="">
                            <p class="mb-0">Clear operational direction</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container my-5">
            <div class="row">
                ...
                <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                    ...
                    <h1 class="playfairText themeText mt-3">Strengthen your direction</h1>
                    <p>
                        We work closely with your leadership team to define a strategy that gives clarity, direction, and measurable targets. Our approach blends insight, structure, and on-ground practicality so teams know exactly where the organization is heading and how to get there.
                    </p>
                    <ul class="strengthList">
                        <li>Build strategies your teams can act on</li>
                        <li>Bring alignment across leadership and functions</li>
                        <li>Replace guesswork with measurable direction</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row mt-4">
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="strategyCard">
                        ...
                        <h5 class="fw-light">
                            21% faster decision-making cycles
                        </h5>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="strategyCard">
                        <img src="/assets/image/tickImg5.png" class="img-fluid" alt="">
                        <h5 class="fw-light">
                            42% improvement in KPI visibility
                        </h5>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="strategyCard">
                        <img src="/assets/image/tickImg5.png" class="img-fluid" alt="">
                        <h5 class="fw-light">
                            18% reduction in operational delays
                        </h5>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 col-xl-3">
...
.serviceBnr {
    position: relative;
    background-image: linear-gradient(68deg,rgb(0, 0, 0, 0.5),rgb(0, 0, 0,0)),url('/assets/image/Business-Strategy-service.webp');
