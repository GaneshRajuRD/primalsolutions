<template>
    <div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-lg-5">
                            <div class="processImg">
                                <img src="/assets/image/OptimizeplanlayoutImg.webp" class="mt-sm-5 mt-lg-0  img-fluid w-100" alt="">
                            </div>
                        </div>
                        <div class="col-sm-8 col-lg-7 ps-xl-5 mt-5 pt-xl-4">
                            ...
                            <ul class="strengthList">
                                <li>
                                    ...
                                    We design end-to-end plant layouts from concept to commissioning, optimizing material flow, space utilization, and future scalability.
                                <li>
                                    <strong>Expansion or Plant Re-Layout – Brownfield</strong>
                                </li>
                                    We re-engineer existing layouts to support capacity expansion, improve flow efficiency, and minimize disruption to ongoing operations.
                                <li>
                                    <strong>Product or Process Layout Design</strong>
                                </li>
                                    We develop optimized product- and process-based layouts to reduce lead time, handling cost, and operational bottlenecks.
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div ref="textSlider" class="textSlider">
            <div class="text-item">New plant layout planning - Greenfield</div>
            <div class="text-item">Expansion or Plant Re-Layout - Brownfield</div>
            <div class="text-item">Product or Process Layout design</div>
            <div class="text-item">New plant layout planning - Greenfield</div>
            <div class="text-item">Expansion or Plant Re-Layout - Brownfield</div>
            <div class="text-item">Product or Process Layout design</div>
            <div class="text-item">New plant layout planning - Greenfield</div>
